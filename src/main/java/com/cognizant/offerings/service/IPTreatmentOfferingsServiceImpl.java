...
public class IPTreatmentOfferingsServiceImpl implements IPTreatmentOfferingsService {
	 ...
	 * microservice autowires the IPTreatmentOfferingsService autowires the
	 * IPTreatmentOfferingsPackageDetailRepository and
	...
	/**
	 * to return the treatment package based on ailment category and package name
	 * 
	 * @param packageName
	 * @param category
	...
	public IPTreatmentPackage getIPTreatmentPackageByAilmentCategoryAndName(String packageName, String category) {
		...
		if (packageName.equalsIgnoreCase("package1"))
			packageDetail = ipTreatmentOfferingsPackageDetailRepository.findByName("Package 1", category);
		else
			packageDetail = ipTreatmentOfferingsPackageDetailRepository.findByName("Package 2", category);
