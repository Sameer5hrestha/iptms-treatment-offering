...
public class IPTreatmentOfferingsController {
	 ...
	 * 
	 * to get the list of all the treatment packages available for patients only
	 * after verifying that the user trying to use this service is authenticated or
	 * not
	 * 
	 * @param token
	 ...
	 * package name only after verifying that the user trying to use this service is
	 ...
	 * 
	 * to return the list of all the specialist details only after verifying that
	 * the user trying to use this service is authenticated or not
	 * 
	 * @param token
