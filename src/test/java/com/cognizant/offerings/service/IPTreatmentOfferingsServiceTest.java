...
public class IPTreatmentOfferingsServiceTest {
	...
	/**
	 * to test that IP treatment package based on ailment category and package name
	 * is fetched properly
	 */
	@Test
	public void testGetIPTreatmentPackageByAilmentCategoryAndName() {
		...
		assertEquals(iPTreatmentPackage2, ipTreatmentOfferingsServiceImpl
				.getIPTreatmentPackageByAilmentCategoryAndName("package2", "Orthopaedics"));
//
		assertThrows(PackageDetailNotFoundException.class, () -> ipTreatmentOfferingsServiceImpl
				.getIPTreatmentPackageByAilmentCategoryAndName("Package 2", "Urology"));
	}
	...
	public void testGetSpecialists() {
		...
		SpecialistDetail specialistDetail = new SpecialistDetail(1, "Dr. Varun Mehta", "Orthopaedics", 12,
				"9876543210");
